...
import com.Fishmod.mod_LavaCow.item.ItemIllagerNose;
...
public class FishItems {
    ...
    public static ArmorMaterial ARMOR_ILLAGER_NOSE = EnumHelper.addArmorMaterial("fur_armor_illager_nose", "illager_nose", 15, new int[]{0, 0, 0, 1}, 10, SoundEvents.ENTITY_ITEM_PICKUP, 0.0F);
    ...
    public static final Item NETHERSTEW = new ItemNetherStew("netherstew", 8, 0.8F).setRandPotionEffect(ItemNetherStew.Effect_nethersoup);
    public static final Item CANEBEEF = new ItemFishCustomFood("canebeef", 6, 0.5F, true, 16, true).setPotionEffect(new PotionEffect(MobEffects.REGENERATION, 5 * 20, 0), 1.0F);
    public static final Item CANEPORK = new ItemFishCustomFood("canepork", 6, 0.5F, true, 16, true).setPotionEffect(new PotionEffect(MobEffects.REGENERATION, 5 * 20, 0), 1.0F);
    public static final Item CANEROTTENMEAT = new ItemFishCustomFood("canerottenmeat", 4, 0.4F, true, 16, true).setPotionEffect(new PotionEffect(MobEffects.STRENGTH, 10 * 20, 0), 1.0F);
    ...
    public static final Item CHEIROLEPIS = new ItemFishCustomFood("cheirolepis", 2, 0.1F, false, 32, false);
    public static final Item CHEIROLEPIS_COOKED = new ItemFishCustomFood("cheirolepis_cooked", 6, 0.8F, false, 32, false);
    ...
    public static final Item GREEN_BACON_AND_EGGS = new ItemNetherStew("green_bacon_and_eggs", 10, 1.2F).setPotionEffect(new PotionEffect(MobEffects.HASTE, 120 * 20, 1), 1.0F).setAlwaysEdible();
    ...
    public static final Item SAUSAGE_ROLL = new ItemFishCustomFood("sausage_roll", 9, 0.9F, true, 32, false);
    ...
    public static final Item BONE_STEW = new ItemNetherStew("bonestew", 10, 1.2F).setMultiPotionEffect(ItemNetherStew.Effect_bonestew).setAlwaysEdible();
    ...
    public static final Item SOULFORGED_HAMMER = new ItemFishCustomWeapon("soulforged_hammer", TOOL_SOULFORGED, 6.0F, -2.4F, FishItems.ECTOPLASM_INGOT, EnumRarity.EPIC);
    public static final Item SOULFORGED_AXE = new ItemSoulforgedAxe("soulforged_axe");
    public static final Item SOULFORGED_PAN = new ItemFishCustomWeapon("soulforged_pan", TOOL_SOULFORGED, 4.0F, -2.6F, FishItems.ECTOPLASM_INGOT, EnumRarity.EPIC);
    ...
    public static final Item GHOSTLY_BOOTS = new ItemGhostlyArmor("ghostlyarmor_boots", 2, EntityEquipmentSlot.FEET);
    public static final Item SOULFORGEDARMOR_HELMET = new ItemSoulforgedArmor("soulforgedarmor_helmet", 2, EntityEquipmentSlot.HEAD, 0.2F).setCreativeTab(mod_LavaCow.TAB_ITEMS);
    ...
    public static final SoundEvent ENTITY_GRAVE_ROBBER_GHOST_AMBIENT = new SoundEvent(new ResourceLocation(mod_LavaCow.MODID, "entity.graverobberghost.ambient")).setRegistryName("entity_graverobberghost_ambient");
    public static final SoundEvent ENTITY_GRAVE_ROBBER_GHOST_HURT = new SoundEvent(new ResourceLocation(mod_LavaCow.MODID, "entity.graverobberghost.hurt")).setRegistryName("entity_graverobberghost_hurt");
    public static final SoundEvent ENTITY_GRAVE_ROBBER_GHOST_DEATH = new SoundEvent(new ResourceLocation(mod_LavaCow.MODID, "entity.graverobberghost.death")).setRegistryName("entity_graverobberghost_death");
