...
public class Modconfig {
    ...
    public static double Wendigo_Attack_Volume;
    ...
    private void syncConfigs() {
        ...
        RLCombat_Compat = config.get(Configuration.CATEGORY_GENERAL, "rlcombat integration", true, "Should some weapons use RLCombat for handling? [false/true]").getBoolean(true);
